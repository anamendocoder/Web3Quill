 ...
 * This file demonstrates how to integrate Web3quill with a web frontend
 */

// For React/Vue/Angular applications
export class Web3quillClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Web3quillClient(provider, contractAddress);
